...
function _typeof(e) {
    ...
    function o(e) {
        /*if (console.error("[ZemezCore] error:", "\n", e), !document.querySelector("#global-error")) {
            ...
            t.setAttribute("id", "global-error"), t.setAttribute("style", "position: fixed; bottom: 1vh; left: 1vw; z-index: 1000; max-width: 98vw; padding: 10px 15px; border-radius: 4px; font-family: monospace; background: #f2564d; color: white; display: none;"), t.innerText = "There was an error on this page, please try again later.", document.body.appendChild(t)
        }*/
    }
